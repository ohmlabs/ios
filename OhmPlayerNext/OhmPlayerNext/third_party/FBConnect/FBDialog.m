...
- (void)sizeToFitOrientation:(BOOL)transform {
  ...
  CGFloat height = floor(scale_factor * frame.size.height) - kPadding * 2;
	...
	// ISSUE: Ohm - This code is bogus! startBarOrientation returns a UIInterfaceOrientation
	// but the code is written in terms of a UIDeviceOrientation!
	
	// The temporary fix is to cast from a UIInterfaceOrientation to a UIDeviceOrientation to satify
	// the compiler.
	
	// I tried to change the code to use UIDeviceOrientation but of course then the dialog
	// rotates but draws incorrectly. Ohm should fix this and let
	// Facebook know. I'll get it working soon, but it's not a high priority now.
